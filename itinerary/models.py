...
class Site(models.Model):
    ...
    # tempid = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
...
class Itinerary(models.Model):
    ...
    lunch2 = models.ForeignKey(Restaurant, on_delete=models.SET_NULL, null = True, related_name='lunch2')
